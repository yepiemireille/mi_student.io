...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-5" style="margin-top: 20px;">
      <div class="card">
        <div class="card-header">Login &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php" style="text-decoration: none;">retour</a></div>
        <div id="message_etud"></div>
        <div class="card-body">
          <form method="post" id="login_form_etud">
            ...
            <div class="form-group">
              <input type="submit" name="etudlogin" id="etudlogin" class="btn btn-info" value="Login" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="forgetud_mdp.php">j'ai oublier mon mot de passe</a>
            </div>
          </form>
        </div>
      </div>
